...
export const mockKnowledgeFiles: KnowledgeSupportFile[] = [
  createKnowledgeFile({
    ...
    filename: "emmanuel_visao_geral_resumido.json",
    path: "mock://knowledge/emmanuel/visao-geral",
    groupSlug: "emmanuel",
    groupName: "Emmanuel",
    bookTitle: "Emmanuel",
    type: "visao_geral",
  ...
  createKnowledgeFile({
    ...
    filename: "emmanuel_tema_constancia_resumido.json",
    path: "mock://knowledge/emmanuel/constancia",
    groupSlug: "emmanuel",
    groupName: "Emmanuel",
    bookTitle: "Emmanuel",
    type: "tema",
  ...
  createKnowledgeFile({
    ...
    filename: "emmanuel_tema_aplicacao_pratica_resumido.json",
    path: "mock://knowledge/emmanuel/aplicacao-pratica",
    groupSlug: "emmanuel",
    groupName: "Emmanuel",
    bookTitle: "Emmanuel",
    type: "tema",
  ...
  createKnowledgeFile({
    ...
    filename: "emmanuel_capitulo_01_resumido.json",
    path: "mock://knowledge/emmanuel/capitulo-01",
    groupSlug: "emmanuel",
    groupName: "Emmanuel",
    bookTitle: "Emmanuel",
    type: "capitulo",
  ...
  createKnowledgeFile({
    ...
    filename: "emmanuel_duvidas_frequentes_resumido.json",
    path: "mock://knowledge/emmanuel/faq",
    groupSlug: "emmanuel",
    groupName: "Emmanuel",
    bookTitle: "Emmanuel",
    type: "faq",
  ...
  createKnowledgeFile({
    ...
    filename: "emmanuel_palavras_chave_resumido.json",
    path: "mock://knowledge/emmanuel/palavras-chave",
    groupSlug: "emmanuel",
    groupName: "Emmanuel",
    bookTitle: "Emmanuel",
    type: "palavras_chave",
  ...
  createKnowledgeFile({
    ...
    filename: "a_caminho_da_luz_visao_geral_resumido.json",
    path: "mock://knowledge/a-caminho-da-luz/visao-geral",
    groupSlug: "a-caminho-da-luz",
    groupName: "A Caminho da Luz",
    bookTitle: "A Caminho da Luz",
    type: "visao_geral",
  ...
  createKnowledgeFile({
    ...
    filename: "a_caminho_da_luz_historia_espiritual_resumido.json",
    path: "mock://knowledge/a-caminho-da-luz/historia-espiritual",
    groupSlug: "a-caminho-da-luz",
    groupName: "A Caminho da Luz",
    bookTitle: "A Caminho da Luz",
    type: "tema",
  ...
  createKnowledgeFile({
    ...
    filename: "a_caminho_da_luz_civilizacoes_antigas_resumido.json",
    path: "mock://knowledge/a-caminho-da-luz/civilizacoes-antigas",
    groupSlug: "a-caminho-da-luz",
    groupName: "A Caminho da Luz",
    bookTitle: "A Caminho da Luz",
    type: "tema",
  ...
  createKnowledgeFile({
    ...
    filename: "a_caminho_da_luz_jesus_evangelho_resumido.json",
    path: "mock://knowledge/a-caminho-da-luz/jesus-evangelho",
    groupSlug: "a-caminho-da-luz",
    groupName: "A Caminho da Luz",
    bookTitle: "A Caminho da Luz",
    type: "tema",
  ...
  createKnowledgeFile({
    ...
    filename: "a_caminho_da_luz_duvidas_frequentes_resumido.json",
    path: "mock://knowledge/a-caminho-da-luz/faq",
    groupSlug: "a-caminho-da-luz",
    groupName: "A Caminho da Luz",
    bookTitle: "A Caminho da Luz",
    type: "faq",
  ...
  createKnowledgeFile({
    ...
    filename: "a_caminho_da_luz_palavras_chave_resumido.json",
    path: "mock://knowledge/a-caminho-da-luz/palavras-chave",
    groupSlug: "a-caminho-da-luz",
    groupName: "A Caminho da Luz",
    bookTitle: "A Caminho da Luz",
    type: "palavras_chave",
