...
describe("admin groups list authorization", () => {
  beforeEach(() => {
    resetAuthStore();
  ...
  it("bloqueia admin com troca obrigatória de senha", async () => {
    ...
    await repository.resetPasswordByAdmin({
      ...
      temporaryPasswordGeneratedAt: "2026-07-15T10:00:00.000Z",
      passwordChangedAt: "2026-07-15T10:00:00.000Z",
